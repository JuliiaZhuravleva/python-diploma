    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(message="Телефон должен быть в формате: '+999999999'. До 15 цифр разрешено.", regex='^\\+?1?\\d{9,15}$')], verbose_name='Телефон')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_id', models.PositiveIntegerField(db_index=True, verbose_name='Внешний ИД')),
        ...
        migrations.AddField(
            model_name='shop',
            name='user',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.user', verbose_name='Пользователь'),
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
